...
mv nats-streaming-server-$VERSION-linux-amd64/nats-streaming-server-$VERSION /usr/local/antares/bin
...
mv gnatsd-v1.1.0-linux-amd64/gnatsd /usr/local/antares/bin
