...
/*
 * TODO
 * Ability to remove service on userr request 
 *
 * A service may not be ableto send a signal for graceful shutdown
 * let a user remove it manually if they detect so */
appClient.removeService = function (serviceType, serviceId) {
	log.debug ({serviceType, serviceId}, 'request to delete service entry');
...
appClient.incrimentFailure = function (serviceType, serviceId) {
	log.debug ({serviceType, serviceId}, 'request to incriment failure count for service entry');
	return 'TO BE IMPLIMENTED';
};
 ...
 */
appClient.decrementFailure = function (serviceType, serviceId) {
...
appClient.resetFailure = function (serviceType, serviceId) {
	log.debug ({serviceType, serviceId}, 'request to reset failure count for service entry');
	return 'TO BE IMPLIMENTED';
};
