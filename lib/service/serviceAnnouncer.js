...
serviceAnnouncer.init = function (serviceConfig) {
	return new Promise (function (resolve/*, reject*/) {
		...
		natsiface.open_channel (config.channels.pull, parse_msg);
...
serviceAnnouncer.send = function (state) {
	natsiface.send (config.channels.discovery, new srv_msg (state));
};
 ...
 *
 * TODO
 * Verify if this is properly done or are thigns unhandled */
