...
//TODO -> Ability to provide "custom" key a function also (right now only json,string and standard type will work properly), so that it can dynamically denerate values like cpuLoad etc. A user mmight want that
*/
